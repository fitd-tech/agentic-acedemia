...
2. Assess whether the changes represent one logical unit of work or multiple. If the diff spans unrelated concerns (e.g. a bug fix and a new feature, or changes to two independent experiments), split into separate commits — one per concern — before pushing.
